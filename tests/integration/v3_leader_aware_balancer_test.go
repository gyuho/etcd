...
func TestLeaderAwareBalancerFailover(t *testing.T) {
	...
	require.NotEqual(t, oldLeadID, newLeadID, "leader did not change after stopping the old leader")
...
func TestLeaderAwareBalancerMoveLeader(t *testing.T) {
	...
	for i := range clus.Members {
		...
		require.Equal(t, targetID, newID, "leader transition did not reach member %d", i)
	}
